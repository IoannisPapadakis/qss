...
election.map(election.total, 2012)
```

![](mapping_us_elections_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
}, htmlfile = "mapping_us_elections.html", outdir = getwd(), autobrowse = FALSE)
```
    ...
    ## HTML file created at: mapping_us_elections.html
